...
// Release signing lives outside the repo: key.properties and the keystore are
// gitignored, because publishing with a leaked key lets anyone ship an update
// that Play will accept as genuine. Copy key.properties.example to get started.
...
android {
    ...
    defaultConfig {
        ...
        applicationId = "com.notably.notably"
    ...
    buildTypes {
        release {
            ...
            // locally without the keystore. Play rejects debug-signed uploads,
            // so a real release build needs key.properties present.
