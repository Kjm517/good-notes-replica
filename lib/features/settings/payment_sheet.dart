...
class _PaymentSheetState extends ConsumerState<PaymentSheet> {
  ...
  double get _subtotal => widget.plan == BillingPlan.yearly ? 39.99 : 4.99;
  ...
  Widget build(BuildContext context) {
    ...
    final trialNote = widget.plan == BillingPlan.yearly
        ? 'Then \$${(_subtotal - _discount).toStringAsFixed(2)}/yr on ${DateFormat.yMMMd().format(renew.add(const Duration(days: 358)))}'
        : 'Then \$${(_subtotal - _discount).toStringAsFixed(2)}/mo on ${DateFormat.yMMMd().format(renew.add(const Duration(days: 23)))}';
            ...
            child: Column(
              ...
              children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            '7-day free trial, then \$${_subtotal.toStringAsFixed(2)}'
                            '${widget.plan == BillingPlan.yearly ? '/yr' : '/mo'}',
                ...
                if (_dueToday < _subtotal)
                  _SummaryRow(
                    label: 'Trial credit',
                    value: '−\$${_dueToday.toStringAsFixed(2)}',
                    valueColor: t.success,
                  ),
